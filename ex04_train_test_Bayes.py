...
def classify_data(filename_data_pos,filename_data_neg,folder_out):
    ...
    #Classifier = classifier_FC.classifier_FC()
    #Classifier = classifier_DNN.classifier_DNN()
    #Classifier = classifier_TF_Keras.classifier_TF_Keras()
...
if __name__ == '__main__':
    ...
    classify_data(folder_in+'data_pos.txt', folder_in+'data_neg.txt',folder_out)
