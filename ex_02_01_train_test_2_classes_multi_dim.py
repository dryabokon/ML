...
def E2E_features_2_classes_multi_dim(filename_data_pos, filename_data_neg, folder_out, has_header,has_labels_first_col):
    ...
    return
# ---------------------------------------------------------------------------------------------------------------------
def E2E_features_2_classes_multi_dim_train_test(filename_train,filename_test,folder_out,has_header,has_labels_first_col):
    do_swap = True
    if do_swap:
        filename_train, filename_test = filename_test, filename_train
    ML = tools_ML.tools_ML(Classifier)
    ML.E2E_features_2_classes_multi_dim_train_test(folder_out, filename_train, filename_test,has_header,has_labels_first_col)
    return
# ----------------------------------------------------------------------------------------------------------------------
...
# ----------------------------------------------------------------------------------------------------------------------
#has_header,has_labels_first_col = True, True
#folder_in = 'data/ex_pos_neg_football2/'
# ----------------------------------------------------------------------------------------------------------------------
has_header,has_labels_first_col = True, True
...
if __name__ == '__main__':
    ...
    E2E_features_2_classes_multi_dim_train_test(folder_in+'train.txt', folder_in+'test.txt',folder_out,has_header,has_labels_first_col)
